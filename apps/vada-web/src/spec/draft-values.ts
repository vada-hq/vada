...
import { DRAFT_FIELDS_BY_SCOPE } from './screen-runtime.generated'
...
export function fieldsOfScope(scopeKey: string | undefined): DraftFields {
  ...
  const fields = DRAFT_FIELDS_BY_SCOPE[scopeKey]
  return fields === undefined
    ? { booleans: new Set(), lists: [] }
    : { booleans: new Set(fields.booleans), lists: fields.lists }
}
