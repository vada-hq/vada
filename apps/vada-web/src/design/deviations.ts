...
export const DEVIATIONS: Deviation[] = [
  // --- 규칙에 건다: 화면이 몇이든 한 줄 ---------------------------------------
  {
    ...
    screen: '화면에 없음',
    why:
      "**그림과 서버가 어긋난다.** MY-01은 줄의 딱지를 '검토 필요'로 그리고 그 줄을 '해야 할 업무'에 놓았는데, 서버는 단계 `review`를 '검토 중'이라 부르고 '진행 중'에 넣는다(검토 중인 업무는 아직 안 끝났다). **사람이 정했다(2026-09-07): 서버대로 둔다.** 그림의 갈피 수 2/2/0은 지키려고 개발용 응답의 앞 두 줄을 '예정'으로 두었고, 남는 차이가 이 딱지의 말과 색이다.",
  },
  {
    by: 'place',
    screenId: 'MY-01',
  ...
  },
  {
    by: 'place',
    screenId: 'MY-01',
    content: "행사 안전 안내문 검토 기획부 검토 필요 다음 행동 검토 의견을 확인하고 처리 내용을 기록 2026 소프트웨어융합대학 체육대회 · 07.22 · 연결 문서 행사 안전 안내문 검토 관련 문서",
    kind: '칸 없음',
    design: '배경 white(#FFFFFF) / 테두리 violet-500(#8E51FF)',
    screen: '화면에 없음',
    why:
      "**그림과 서버가 어긋난다.** MY-01은 줄의 딱지를 '검토 필요'로 그리고 그 줄을 '해야 할 업무'에 놓았는데, 서버는 단계 `review`를 '검토 중'이라 부르고 '진행 중'에 넣는다(검토 중인 업무는 아직 안 끝났다). **사람이 정했다(2026-09-07): 서버대로 둔다.** 그림의 갈피 수 2/2/0은 지키려고 개발용 응답의 앞 두 줄을 '예정'으로 두었고, 남는 차이가 이 딱지의 말과 색이다.",
  },
  {
    by: 'place',
    screenId: 'MY-01',
    content: '학생 건의 답변 문안 검토 기획부 검토 필요 다음 행동 검토 의견을 확인하고 처리 내용을 기록 상시 업무 · 07.22',
    kind: '칸 없음',
    design: '배경 white(#FFFFFF) / 테두리 violet-500(#8E51FF)',
    screen: '화면에 없음',
    why:
