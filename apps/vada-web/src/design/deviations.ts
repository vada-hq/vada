...
//
// **`by: 'place'` 중 41곳은 사람의 판단이다** — 와이어프레임 두 장이 같은 것을 다르게
// 그려서 한쪽을 골라야 했던 자리다. 그 판단들은 아래 why에 흩어져 있는데, 고르는
// 잣대와 일곱 갈래를 `docs/decisions/product-decisions.md`가 한곳에 모아 두었다.
// 여덟 번째 갈래가 나오면 잣대가 규칙이 아니라 변명이 된 것이므로 거기부터 보라.
...
export const DEVIATIONS: Deviation[] = [
  ...
  // --- FIN-00: 증빙 상태의 말을 하나로 모은 대가 ------------------------------
  {
    ...
    screen: '화면에 없음',
    why:
      '**와이어프레임이 같은 절차를 두 말로 그렸다** — 전체 재정은 ‘증빙 완료 / 보완 필요 / 미등록’, 사용 내역은 ‘완료 / 누락 / 확인 중’이다. 한 지출의 증빙은 한 가지 상태이므로 서버가 두 말을 쓸 수 없다. 그려진 줄이 더 많은 사용 내역 쪽으로 통일했다(docs/decisions/product-decisions.md).',
  },
  {
    by: 'place',
    screenId: 'FIN-00',
  ...
  },
  {
    ...
    screenId: 'FIN-00',
    content:
      '최근 지출 내역 사용 내역 전체 보기 날짜 지출 내용 행사 또는 사용처 금액 증빙 상태 07.17 현수막 제작 체육대회 180,000원 증빙 완료 07.16 생수 구매 체육대회 120,000원 보완 필요 07.15 명찰 인쇄 신입생 환영 행사 75,000원 미등록',
    kind: '칸 없음',
  ...
  },
  {
    ...
    screenId: 'FIN-00',
    content:
      '07.17 현수막 제작 체육대회 180,000원 증빙 완료',
    kind: '칸 없음',
    design: '배경 지정 없음 / 테두리 gray-50(#F9FAFB)',
    screen: '화면에 없음',
    why:
      '**와이어프레임이 같은 절차를 두 말로 그렸다** — 전체 재정은 ‘증빙 완료 / 보완 필요 / 미등록’, 사용 내역은 ‘완료 / 누락 / 확인 중’이다. 한 지출의 증빙은 한 가지 상태이므로 서버가 두 말을 쓸 수 없다. 그려진 줄이 더 많은 사용 내역 쪽으로 통일했다(docs/decisions/product-decisions.md).',
  },
  {
    ...
    content:
      '증빙 완료',
    kind: '칸 없음',
    design: '배경 green-50(#F0FDF4) / 테두리 지정 없음',
    screen: '화면에 없음',
    why:
      '**와이어프레임이 같은 절차를 두 말로 그렸다** — 전체 재정은 ‘증빙 완료 / 보완 필요 / 미등록’, 사용 내역은 ‘완료 / 누락 / 확인 중’이다. 한 지출의 증빙은 한 가지 상태이므로 서버가 두 말을 쓸 수 없다. 그려진 줄이 더 많은 사용 내역 쪽으로 통일했다(docs/decisions/product-decisions.md).',
  },
  {
    ...
    screenId: 'FIN-00',
    content:
      '07.16 생수 구매 체육대회 120,000원 보완 필요',
    kind: '칸 없음',
    design: '배경 지정 없음 / 테두리 gray-50(#F9FAFB)',
    screen: '화면에 없음',
    why:
  ...
  },
  {
    ...
    content:
      '보완 필요',
    kind: '칸 없음',
    design: '배경 yellow-50(#FEFCE8) / 테두리 지정 없음',
    screen: '화면에 없음',
    why:
      '**와이어프레임이 같은 절차를 두 말로 그렸다** — 전체 재정은 ‘증빙 완료 / 보완 필요 / 미등록’, 사용 내역은 ‘완료 / 누락 / 확인 중’이다. 한 지출의 증빙은 한 가지 상태이므로 서버가 두 말을 쓸 수 없다. 그려진 줄이 더 많은 사용 내역 쪽으로 통일했다(docs/decisions/product-decisions.md).',
  },
  {
    ...
    content:
      '미등록',
    kind: '칸 없음',
    design: '배경 red-50(#FEF2F2) / 테두리 지정 없음',
    screen: '화면에 없음',
    why:
      '**와이어프레임이 같은 절차를 두 말로 그렸다** — 전체 재정은 ‘증빙 완료 / 보완 필요 / 미등록’, 사용 내역은 ‘완료 / 누락 / 확인 중’이다. 한 지출의 증빙은 한 가지 상태이므로 서버가 두 말을 쓸 수 없다. 그려진 줄이 더 많은 사용 내역 쪽으로 통일했다(docs/decisions/product-decisions.md).',
  },
  ...
  // --- ORG-04B: 그림이 그린 것은 '자기 자신이 골라진 순간'이다 ------------------
  //
  // 고른 사람이 화면의 값이 되면서(itemAction.choose) 처음 골라져 있는 사람이 바뀌었다.
  // 그림은 보는 사람(박해랑)을, 화면은 목록의 첫 줄(김바다)을 고른다.
  {
    by: 'place',
    screenId: 'ORG-04B',
    content:
      "박해랑 운영부 부원",
    kind: '배경',
    design: "blue-50(#EFF6FF)",
    screen: "지정 없음",
    why:
      '**그림은 자기 자신이 골라진 순간을 그렸다**' + '— ORG-04B의 박해랑은 보는 사람이고, 와이어프레임은 그 사람이 골라져 있는 한 장면을 그렸다. ' + '그런데 화면이 ‘누가 나인가’를 알 길이 명세에 없다 — shell.viewer는 이름과 이어 붙인 역할만 주고 구성원 id를 주지 않는다. ' + '그래서 목록의 첫 줄을 골라 둔다(spec/chosen.ts). 고른 사람이 화면의 값이 되는 어휘를 만들면서 생긴 자리이고, ' + '서버가 ‘마지막으로 고른 사람’을 기억하던 것을 없앤 대가다.',
  },
  {
    by: 'place',
    screenId: 'ORG-04B',
  ...
  },
  {
    ...
    content:
      "부원",
    kind: '칸 없음',
    design: "배경 gray-50(#F9FAFB) / 테두리 gray-200(#E5E7EB)",
    screen: "화면에 없음",
    why:
      '**그림은 자기 자신이 골라진 순간을 그렸다**' + '— ORG-04B의 박해랑은 보는 사람이고, 와이어프레임은 그 사람이 골라져 있는 한 장면을 그렸다. ' + '그런데 화면이 ‘누가 나인가’를 알 길이 명세에 없다 — shell.viewer는 이름과 이어 붙인 역할만 주고 구성원 id를 주지 않는다. ' + '그래서 목록의 첫 줄을 골라 둔다(spec/chosen.ts). 고른 사람이 화면의 값이 되는 어휘를 만들면서 생긴 자리이고, ' + '서버가 ‘마지막으로 고른 사람’을 기억하던 것을 없앤 대가다.',
  },
  {
    ...
    screenId: 'ORG-04B',
    content:
      "기본 역할 변경 박해랑 운영부 · 현재  부원 회장단 학생회 전체 운영을 총괄하고 재정 처리를 승인합니다. 부서장 소속 부서의 업무와 구성원을 관리합니다. 부원 부서 업무에 참여하고 구매 요청 등을 제출합니다. 되돌리기 권한 변경",
    kind: '칸 없음',
    design: "배경 white(#FFFFFF) / 테두리 gray-200(#E5E7EB)",
    screen: "화면에 없음",
    why:
  ...
  },
  {
    ...
    screenId: 'ORG-04B',
    content:
      "회장단 학생회 전체 운영을 총괄하고 재정 처리를 승인합니다.",
    kind: '테두리',
  ...
  },
  {
    ...
    content:
      "부원 부서 업무에 참여하고 구매 요청 등을 제출합니다.",
    kind: '테두리',
    design: "blue-400(#51A2FF)",
    screen: "gray-200(#E5E7EB)",
    why:
      '**그림은 자기 자신이 골라진 순간을 그렸다**' + '— ORG-04B의 박해랑은 보는 사람이고, 와이어프레임은 그 사람이 골라져 있는 한 장면을 그렸다. ' + '그런데 화면이 ‘누가 나인가’를 알 길이 명세에 없다 — shell.viewer는 이름과 이어 붙인 역할만 주고 구성원 id를 주지 않는다. ' + '그래서 목록의 첫 줄을 골라 둔다(spec/chosen.ts). 고른 사람이 화면의 값이 되는 어휘를 만들면서 생긴 자리이고, ' + '서버가 ‘마지막으로 고른 사람’을 기억하던 것을 없앤 대가다.',
  },
  // --- ORG-04: 그림이 지킬 수 없는 것을 약속한 자리 ---------------------------
  //
  // 권한 표의 '구성원 초대 / 부서장' 칸이다. 그림은 '자기 부서만'을 노란 딱지로
  // 그렸는데, 초대 코드는 학생회에 하나뿐이라 부서를 가릴 수가 없다. 규칙을 옮겨
  // 적으면서(permissions.json) 드러났고, 사람이 '초대는 회장단만'으로 정했다.
  {
    by: 'place',
    screenId: 'ORG-04',
    content:
      '기능 영역별 권한 기능 영역 회장단 부서장 부원 재정 현황·사용 내역 열람 가능 가능 가능 예산 수정·구매 승인·증빙 처리 가능 재정부만 재정부만 ' + '회의 생성 가능 가능 — 행사 만들기 가능 가능 — 행사 정보 수정·종료 처리 가능 행사 조직만 행사 조직만 행사 완료 처리 가능 — — ' + '행사 운영 조직 구성·수정 가능 행사 조직 관리자만 행사 조직 관리자만 조직 구조 수정 가능 — — 구성원 초대 가능 자기 부서만 — ' + '학생 명단 열람 가능 가능 가능 학생 명단 업로드·갱신 가능 — — 학생회비 납부 명단 업로드 가능 재정부만 재정부만 학생 명단 내보내기 가능 — — ' + '‘—’는 해당 역할이 사용할 수 없는 기능입니다. 회의·행사별로 부여되는 역할은 아래 카드를 참고하세요.',
    kind: '칸 없음',
    design: '배경 white(#FFFFFF) / 테두리 gray-200(#E5E7EB)',
    screen: '화면에 없음',
    why:
      '**와이어프레임이 지킬 수 없는 것을 약속했다**' + '— 표는 구성원 초대를 부서장에게 ‘자기 부서만’ 준다고 그렸는데, 초대 코드는 학생회에 하나뿐이라 부서를 가릴 수가 없다. ' + '부서장이 코드를 다시 만들면 학생회 전체의 코드가 바뀐다. 2026-08-30에 사람이 ‘초대는 회장단만’으로 정했고, 그래서 이 칸은 ‘—’다(specs/figma/vada-wireframe/permissions.json).',
  },
  {
    by: 'place',
    screenId: 'ORG-04',
    content: '구성원 초대 가능 자기 부서만 —',
    kind: '칸 없음',
    design: '배경 지정 없음 / 테두리 gray-100(#F3F4F6)',
    screen: '화면에 없음',
    why:
  ...
  },
  {
    ...
    screen: '화면에 없음',
    why:
      '**와이어프레임이 지킬 수 없는 것을 약속했다** — 표는 구성원 초대를 부서장에게 ‘자기 부서만’ 준다고 그렸는데, 초대 코드는 학생회에 하나뿐이라 부서를 가릴 수가 없다. 2026-08-30에 사람이 ‘초대는 회장단만’으로 정했다.',
  },
  {
    by: 'place',
    screenId: 'ORG-04',
  ...
  // --- EXT-02A: 체크 상자를 브라우저가 그린다 ---------------------------------
  //
  // 그림은 체크 상자를 그림 조각(SVG)으로 뽑아 두었다. 화면은 <input
  // type="checkbox">를 쓴다 — 그래야 스페이스로 켜지고 화면을 읽어 주는 기계가
  // 켜짐·꺼짐을 말한다. 뽑아 둔 조각을 대신 얹으면 그림은 같아지고 조작은 사라진다.
  {
    by: 'place',
    screenId: 'EXT-02A',
    content: '30:7221 Checkbox',
    kind: '그림 없음',
    design: 'assets/30-7221.svg',
    screen: 'data-asset-node-id를 단 그림이 없음',
    why:
      '체크 상자는 브라우저의 것이라 그림으로 얹지 않는다. 뽑아 둔 조각을 쓰면 ' +
      '스페이스로 켜지지 않고 읽어 주는 기계가 켜짐을 말하지 못한다.',
  },

  // --- EXT-02C: 갈 곳이 없으면 단추도 없다 ------------------------------------
  //
  // 그림은 막힌 링크의 카드마다 '돌아가기'를 그렸다. **외부인에게 열린 다른 화면이
  // 없다** — 링크로 온 사람에게 돌아갈 곳은 이 링크뿐이고, 그것이 지금 막혀 있다.
  // 사람이 정했다(docs/decisions/product-decisions.md).
  //
  // 갈 곳이 있는 상태 하나(교체됨)에는 단추가 있고, 그 글도 갈 곳도 데이터가 준다
  // (survey.linkState.actionLabel·replacementToken).
  {
    by: 'place',
    screenId: 'EXT-02C',
    content: '돌아가기',
    ...
    screen: '화면에 없음',
    why:
      '외부인에게 열린 다른 화면이 없어 갈 곳이 없다. 지어낸 이동을 만들지 않는다 ' +
      '(docs/decisions/product-decisions.md).',
  },
  {
    by: 'place',
    screenId: 'EXT-02C',
    content: '모집 전 참가 신청이 아직 시작되지 않았습니다. 돌아가기',
    kind: '칸 없음',
    design: '배경 gray-100(#F3F4F6) / 테두리 지정 없음',
    screen: '화면에 없음',
    why:
      '단추가 빠져 카드의 글줄이 통째로 어긋난다. 카드 자체는 그린다 — 대조가 ' +
      '글줄을 이어 붙여 한 덩이로 보기 때문이다.',
  },
  {
    by: 'place',
    screenId: 'EXT-02C',
    content: '돌아가기',
    kind: '칸 없음',
    design: '배경 지정 없음 / 테두리 gray-600(#4A5565)',
    screen: '화면에 없음',
  ...
  },
  {
    ...
    content: "홍보부",
    kind: '글 없음',
    design: "gray-900(#111827)",
    screen: '화면에 없음',
    why: "select의 값은 부서·행사의 id이고 그려지는 이름은 선택지 출처(loadOn: open)에서 늦게 온다. 대조는 첫 그림만 보므로 이름과 그것이 든 칸을 못 본다 — MSG-02와 같은 계열. 초안이 이름까지 실어 오게 하면 사라진다(백로그).",
  },
  {
    by: 'place',
    screenId: 'FIN-PLAN-01',
  ...
  },
  {
    by: 'place',
    screenId: 'FIN-PLAN-01',
    content: "상시 예산 항목 이름 * 운영비 배정액(원) * 3000000 담당 부서(선택) 기획부 지우기 이름 * 홍보비 배정액(원) * 2500000 담당 부서(선택) 홍보부 지우기 이름 * 안전·설비 배정액(원) * 1800000 담당 부서(선택) 기획부 지우기 이름 * 비품 배정액(원) * 1200000 담당 부서(선택) 선택 안 함 지우기 + 항목 추가",
    kind: '칸 없음',
    design: "배경 white(#FFFFFF) / 테두리 gray-200(#E5E7EB)",
    screen: '화면에 없음',
    why: "select의 값은 부서·행사의 id이고 그려지는 이름은 선택지 출처(loadOn: open)에서 늦게 온다. 대조는 첫 그림만 보므로 이름과 그것이 든 칸을 못 본다 — MSG-02와 같은 계열. 초안이 이름까지 실어 오게 하면 사라진다(백로그).",
  },
  {
    by: 'place',
    screenId: 'FIN-PLAN-01',
    content: "이름 * 운영비 배정액(원) * 3000000 담당 부서(선택) 기획부 지우기",
    kind: '칸 없음',
    design: "배경 white(#FFFFFF) / 테두리 지정 없음",
    screen: '화면에 없음',
    why: "select의 값은 부서·행사의 id이고 그려지는 이름은 선택지 출처(loadOn: open)에서 늦게 온다. 대조는 첫 그림만 보므로 이름과 그것이 든 칸을 못 본다 — MSG-02와 같은 계열. 초안이 이름까지 실어 오게 하면 사라진다(백로그).",
  },
  {
    by: 'place',
    screenId: 'FIN-PLAN-01',
    content: "이름 * 홍보비 배정액(원) * 2500000 담당 부서(선택) 홍보부 지우기",
    kind: '칸 없음',
    design: "배경 white(#FFFFFF) / 테두리 지정 없음",
    screen: '화면에 없음',
    why: "select의 값은 부서·행사의 id이고 그려지는 이름은 선택지 출처(loadOn: open)에서 늦게 온다. 대조는 첫 그림만 보므로 이름과 그것이 든 칸을 못 본다 — MSG-02와 같은 계열. 초안이 이름까지 실어 오게 하면 사라진다(백로그).",
  },
  {
    ...
    content: "홍보부",
    kind: '칸 없음',
    design: "배경 white(#FFFFFF) / 테두리 gray-300(#D1D5DC)",
    screen: '화면에 없음',
    why: "select의 값은 부서·행사의 id이고 그려지는 이름은 선택지 출처(loadOn: open)에서 늦게 온다. 대조는 첫 그림만 보므로 이름과 그것이 든 칸을 못 본다 — MSG-02와 같은 계열. 초안이 이름까지 실어 오게 하면 사라진다(백로그).",
  },
  {
    by: 'place',
    screenId: 'FIN-PLAN-01',
    content: "이름 * 안전·설비 배정액(원) * 1800000 담당 부서(선택) 기획부 지우기",
    kind: '칸 없음',
    design: "배경 white(#FFFFFF) / 테두리 지정 없음",
    screen: '화면에 없음',
    why: "select의 값은 부서·행사의 id이고 그려지는 이름은 선택지 출처(loadOn: open)에서 늦게 온다. 대조는 첫 그림만 보므로 이름과 그것이 든 칸을 못 본다 — MSG-02와 같은 계열. 초안이 이름까지 실어 오게 하면 사라진다(백로그).",
  ...
  },
  {
    by: 'place',
    screenId: 'FIN-PLAN-01',
    content: "이름 * 물품비 배정액(원) * 1200000 담당 부서(선택) 기획부 지우기",
    kind: '칸 없음',
    design: "배경 white(#FFFFFF) / 테두리 지정 없음",
    screen: '화면에 없음',
    why: "select의 값은 부서·행사의 id이고 그려지는 이름은 선택지 출처(loadOn: open)에서 늦게 온다. 대조는 첫 그림만 보므로 이름과 그것이 든 칸을 못 본다 — MSG-02와 같은 계열. 초안이 이름까지 실어 오게 하면 사라진다(백로그).",
  },
  {
    by: 'place',
    screenId: 'FIN-PLAN-01',
    content: "이름 * 홍보비 배정액(원) * 800000 담당 부서(선택) 기획부 지우기",
    kind: '칸 없음',
    design: "배경 white(#FFFFFF) / 테두리 지정 없음",
    screen: '화면에 없음',
    why: "select의 값은 부서·행사의 id이고 그려지는 이름은 선택지 출처(loadOn: open)에서 늦게 온다. 대조는 첫 그림만 보므로 이름과 그것이 든 칸을 못 본다 — MSG-02와 같은 계열. 초안이 이름까지 실어 오게 하면 사라진다(백로그).",
  },
  {
    by: 'place',
    screenId: 'FIN-PLAN-01',
    content: "행사별 예산 항목 행사 2026 봄 축제 이름 * 물품비 배정액(원) * 1200000 담당 부서(선택) 기획부 지우기 이름 * 홍보비 배정액(원) * 800000 담당 부서(선택) 기획부 지우기 + 항목 추가",
    kind: '칸 없음',
    design: "배경 white(#FFFFFF) / 테두리 gray-200(#E5E7EB)",
    screen: '화면에 없음',
    why: "select의 값은 부서·행사의 id이고 그려지는 이름은 선택지 출처(loadOn: open)에서 늦게 온다. 대조는 첫 그림만 보므로 이름과 그것이 든 칸을 못 본다 — MSG-02와 같은 계열. 초안이 이름까지 실어 오게 하면 사라진다(백로그).",
