    ...
    projects: [
      {
        ...
        test: {
          ...
          // 이 줄을 지워야 한다.
          isolate: false,
          // DOM 워커는 셋이다. 루트 게이트가 웹을 다른 앱과 분리해 실행하므로
          // 이 셋이 PGlite·계약 검사 워커와 메모리를 다투지 않는다.
          //
          ...
          //
          // "속도 손해도 거의 없다"고 적은 것도 틀렸다. 화면이 늘면서 dom 파일을
          // 줄줄이 도는 값이 커졌다. 현재 1,104건 실측은 워커 2가 83.5초,
          // 워커 3이 70.5초다 — 검사를 지우지 않고 13초를 줄였다.
          //
